...
internal fun buildSlotPlayers(isHomeBatting: Boolean, slots: Array<MutableList<PlayEvent>>): Array<MutableList<String>> {
...
internal fun openSubSelector(container: HTMLElement, idx: Int, isHomeBatting: Boolean) {
