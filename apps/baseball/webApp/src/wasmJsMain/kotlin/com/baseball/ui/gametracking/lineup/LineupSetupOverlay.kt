...
private fun populateWithRosters(
...
private fun renderLineupModalHeader(parent: DIV, validationError: String?) {
    parent.h1 {
...
private fun renderOverlayContainer(parent: HTMLElement, content: DIV.() -> Unit) {
    parent.append {
        div {
            css {
...
private fun renderPitcherRowIfNeeded(
    parent: DIV,
    isHome: Boolean,
    lineupUiContext: LineupUiContext,
    handlers: LineupPitcherChangeHandlers,
...
private fun DIV.renderTeamHeader(isHome: Boolean, lineupUiContext: LineupUiContext) {
    h2 {
