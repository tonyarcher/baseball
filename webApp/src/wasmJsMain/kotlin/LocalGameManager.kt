...
var localAwayActivePitcherId = SeedData.cardinalsRoster.find { it.position == "P" }?.id ?: 210L
var localAwayActivePitcherName = SeedData.cardinalsRoster.find { it.position == "P" }?.name ?: "Sonny Gray"
var localHomeActivePitcherId = SeedData.cubsRoster.find { it.position == "P" }?.id ?: 110L
var localHomeActivePitcherName = SeedData.cubsRoster.find { it.position == "P" }?.name ?: "Justin Steele"

object LocalGameManager {
    ...
    fun initLocalGame() {
        ...
        val homeP = localHomeRoster.find { it.position == "P" } ?: Player(110L, 1L, "Justin Steele", "P", 35, "L", "L")
        val awayP = localAwayRoster.find { it.position == "P" } ?: Player(210L, 2L, "Sonny Gray", "P", 54, "R", "R")
        ...
        localAwayBench.addAll(localAwayRoster.filter { it.position == "P" && it.id != localAwayActivePitcherId } + localAwayRoster.drop(10))
        ...
        localHomeBench.addAll(localHomeRoster.filter { it.position == "P" && it.id != localHomeActivePitcherId } + localHomeRoster.drop(10))
